function printpdf() {
    ...
    // Hide buttons and input checkboxes for printing
    const buttonsToHide = content.querySelectorAll("button");
    buttonsToHide.forEach(button => {
        button.style.display = "none";
    });
    const checkboxesToHide = content.querySelectorAll(".input-checkbox");
    checkboxesToHide.forEach(checkbox => {
    ...
    html2pdf(content, {
        ...
        onAfterPdfGeneration: () => {
            // Restore buttons and input checkboxes after PDF generation
            buttonsToHide.forEach(button => {
